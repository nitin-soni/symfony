...
$k(document).ready(function() {
    ...
    $k(".add-to-links a").hover(function() {
        $k(this).next("em").animate({opacity: "show", top: "-30px"}, "slow");
    }, function() {
        $k(this).next("em").animate({opacity: "hide", top: "-30px"}, "fast");
    });
});
...
function productCarouselAutoSet() {
    $k(".main .product-carousel, #home_page_slider .product-carousel,.additional-carousel .product-carousel").each(function() {
        ...
        var slider = $k(".main #" + objectID + ", #home_page_slider #" + objectID + ", .additional-carousel #" + objectID);
